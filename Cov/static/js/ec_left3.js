function start_roll() {
    ...
    var wrapper = document.getElementById('hotsearch_wrapper');
    var li1 = document.getElementById('hotsearch_wrapper_li1');
    var li2 = document.getElementById('hotsearch_wrapper_li2');
